...
//Agregando las cards de la sección productos en el inicio
const fotos = ['/media/img-mate3.jpg', '/media/img-bowl3.jpg', '/media/img-plato7.jpg', '/media/img-taza3.jpg', '/media/img-escultura.jpg']
...
for (let i=0; i<fotos.length; i++){
    ...
    <img src="'+ imagen +'" class="imagen-card"> 
    </div> </div>`;
}
